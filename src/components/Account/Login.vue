  ...
  <div class="w-full h-full rounded-3xl overflow-hidden flex shadow-2xl">
    ...
    <div class="w-full h-full pt-[88px] bg-gray-300">
      ...
      <div class="w-full h-full flex flex-col items-center">
        ...
        <button class="text-sm mb-20 hover:underline hover:underline-offset-4">
          ForgetPassword?
        </button>
        <ul class="flex gap-6 items-center">
          <li class="w-10 h-10 p-1 cursor-pointer hover:bg-slate-400 rounded-md">
            <img src="@/assets/images/google.svg" alt="" />
          </li>
          <li class="w-9 h-9 p-1 cursor-pointer hover:bg-slate-400 rounded-md">
        ...
        <button class="w-52 h-10 bg-orange-300 mt-5 rounded-xl btn flex items-center justify-center">
          <span class="absolute z-10">login</span>
        </button>
        <!-- --------------------<<>>-------------------- -->
      </div>
    </div>
